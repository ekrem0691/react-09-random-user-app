...
function App() {
  ...
  const handlePage = () => {
    window.open("https://www.linkedin.com/in/ekrm-sryr-444761223/" , "_blank");
  };
  const handle1Page = () => {
    window.open("https://github.com/ekrem0691" , "_blank");
  };
  ...
  return (
    <div className="App">
      ...
      <div className="second" onClick={handlePage}>
        <h1 className="h1name">Ekrem BORA</h1>
        <img className="design-img" src={design} alt="" />
        <h1 className="h1design">LİNKEDLN</h1>
      </div>
      <div className="second" onClick={handle1Page}>
        <h1 className="h1name">Ekrem BORA</h1>
        <img className="design-img" src={design} alt="" />
        <h1 className="h1design">Git-Hub</h1>
      </div>
